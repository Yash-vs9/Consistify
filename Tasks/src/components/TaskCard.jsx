...
const TaskCard = ({ task }) => {
  ...
  const diffInDays=end.getDate-start.getDate
  ...
  return (
    <div className="relative bg-gray-950 text-white p-6 rounded-2xl shadow-xl transition-transform duration-200 hover:-translate-y-1 flex flex-col gap-2">
      ...
      <div className='text-white-100'>
        <button className='absolute bottom-[20px] bg-green-400 px-4 py-1 rounded ' onClick={()=>navigate(`/task/edit/${encodeURIComponent(task.taskName)}`)}>Edit</button>
